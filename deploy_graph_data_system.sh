...
scripts/setup/setup_ansible_key.sh

# Setup GKE Cluster
scripts/setup/setup_gke.sh
...
scripts/provision_and_join_new_scylla_vm.sh -c GraphDev -i 10.138.0.5 -t n1-standard-4 -s 100
scripts/provision_and_join_new_scylla_vm.sh -c GraphDev -n 10.138.0.5 -i 10.138.0.6 -t n1-standard-4 -s 100
scripts/provision_and_join_new_scylla_vm.sh -c GraphDev -n 10.138.0.5 -i 10.138.0.7 -t n1-standard-4 -s 100
